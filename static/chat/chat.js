...
document.getElementById(`sendMessage`).addEventListener(`click`, function () {
  ...
  // document.getElementById(`textMessage`).innerHTML = "";
    ...
    database.child(`msg/${currentuser}/${recieverId}/Messages`).push(messageObj);
    ...
    database.child(`msg/${recieverId}/${currentuser}/Messages`).push(messageObjRec);
    yourMessage = ""
...
database.child(`msg/${currentuser}/${recieverId}/Messages`).on(`child_added`, messages => {
